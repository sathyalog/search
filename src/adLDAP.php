...
class adLDAP {
    ...
    * @var string
    */
	protected $baseDn = "DC=rediminfo,DC=com"; 
    ...
    * @var array
    */
    protected $domainControllers = array("dc01.rediminfo.com");
    ...
    * @var string
    */
	protected $adminUsername = "suhasrao.s";
    protected $adminPassword = "Redim100$";
